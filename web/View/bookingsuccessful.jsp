...
<div style="text-align:center;padding:40px;background:url(&quot;assets/img/plane.jpg&quot;)no-repeat;background-size:cover;">
    <div class="jumbotron" style="border-radius:20px;padding:40px;background:rgba(255,255,255,0.75);margin-top:10px;text-align:center;position:relative;">
        <h2 style="color:rgb(34,139,34);"><strong>Booking Successful!</strong></h2><img src="assets/img/ok.png">
        <h5><strong>An email has been sent to your email address about your flight itinerary</strong></h5></div>
</div>
